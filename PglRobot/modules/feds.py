...
import ElctroRobot.modules.sql.feds_sql as sql
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "ElctroRobot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="ElctroRobot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "ElctroRobot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="ElctroRobot_fbanned_users.csv",
