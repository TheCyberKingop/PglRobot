...
import ElctroRobot.modules.sql.welcome_sql as sql
import ElctroRobot
...
from ElctroRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ElctroRobot.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                creator = None
                if not ElctroRobot.ALLOW_CHATS:
