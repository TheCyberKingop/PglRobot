...
import ElectroRobot.modules.sql.chatbot_sql as sql
from coffeehouse.api import API
from coffeehouse.exception import CoffeeHouseError as CFError
from coffeehouse.lydia import LydiaAI
from ElectroRobot import AI_API_KEY, OWNER_ID, SUPPORT_CHAT, dispatcher
from ElectroRobot.modules.helper_funcs.chat_status import user_admin
from ElectroRobot.modules.helper_funcs.filters import CustomFilters
from ElectroRobot.modules.log_channel import gloggable
...
def check_message(context: CallbackContext, message):
    ...
    if message.text.lower() == "ElectroRobot":
        return True
    if reply_msg:
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows ElectroRobot to talk and provides a more interactive group chat experience.
