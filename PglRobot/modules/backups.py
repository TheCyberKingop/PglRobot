...
import ElctroRobot.modules.sql.notes_sql as sql
from ElctroRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ElctroRobot.__main__ import DATA_IMPORT
from ElctroRobot.modules.helper_funcs.chat_status import user_admin
from ElctroRobot.modules.helper_funcs.alternate import typing_action

# from ElctroRobot.modules.rules import get_rules
import ElctroRobot.modules.sql.rules_sql as rulessql

# from ElctroRobot.modules.sql import warns_sql as warnssql
import ElctroRobot.modules.sql.blacklist_sql as blacklistsql
from ElctroRobot.modules.sql import disable_sql as disabledsql

# from ElctroRobot.modules.sql import cust_filters_sql as filtersql
# import ElctroRobot.modules.sql.welcome_sql as welcsql
import ElctroRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("ElctroRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ElctroRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ElctroRobot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ElctroRobot{}.backup".format(chat_id))  # Cleaning file
