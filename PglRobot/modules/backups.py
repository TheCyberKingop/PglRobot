...
from ElectroRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ElectroRobot.__main__ import DATA_IMPORT
from ElectroRobot.modules.helper_funcs.chat_status import user_admin
from ElectroRobot.modules.helper_funcs.alternate import typing_action

# from ElectroRobot.modules.rules import get_rules
import ElectroRobot.modules.sql.rules_sql as rulessql

# from ElectroRobot.modules.sql import warns_sql as warnssql
import ElectroRobot.modules.sql.blacklist_sql as blacklistsql
from ElectroRobot.modules.sql import disable_sql as disabledsql

# from ElectroRobot.modules.sql import cust_filters_sql as filtersql
# import ElectroRobot.modules.sql.welcome_sql as welcsql
import ElectroRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("ElectroRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ElectroRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ElectroRobot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ElectroRobot{}.backup".format(chat_id))  # Cleaning file
