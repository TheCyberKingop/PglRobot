...
import telegram
from ElctroRobot import TIGERS, WOLVES, dispatcher
from ElctroRobot.modules.disable import DisableAbleCommandHandler
from ElctroRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from ElctroRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
    extract_user_and_text,
)
from ElctroRobot.modules.helper_funcs.filters import CustomFilters
from ElctroRobot.modules.helper_funcs.misc import split_message
from ElctroRobot.modules.helper_funcs.string_handling import split_quotes
from ElctroRobot.modules.log_channel import loggable
from ElctroRobot.modules.sql import warns_sql as sql
...
from ElctroRobot.modules.sql.approve_sql import is_approved
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # ElctroRobot's sticker
        keyboard = None
        log_reason = (
