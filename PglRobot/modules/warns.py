...
import telegram
from ElectroRobot import TIGERS, WOLVES, dispatcher
from ElectroRobot.modules.disable import DisableAbleCommandHandler
from ElectroRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from ElectroRobot.modules.helper_funcs.string_handling import split_quotes
from ElectroRobot.modules.log_channel import loggable
from ElectroRobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # ElectroRobot's sticker
        keyboard = None
        log_reason = (
