...
import ElctroRobot.modules.sql.connection_sql as sql
from ElctroRobot import dispatcher, DRAGONS, DEV_USERS
from ElctroRobot.modules.helper_funcs import chat_status
