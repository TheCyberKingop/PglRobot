...
from ElectroRobot.modules import ALL_MODULES
from ElectroRobot.modules.helper_funcs.chat_status import is_user_admin
from ElectroRobot.modules.helper_funcs.misc import paginate_modules
...
"""
G_START_TEXT = """
Hello ElectroRobot Is In The Chat.
Uptime - {}!
"""
...
ElectroRobot_IMG = "https://telegra.ph/file/f1d7b30b05ba9f0dbf4e5.jpg"

ElectroRobotG_IMG = "https://telegra.ph/file/e8881931bc000c75e8f13.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ElectroRobot.modules." + module_name)
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                text="SOURCE CODE ⚡️",
                                url="https://github.com/iisgaurav/ElectroRobot",
                            ),
                        ],
                    ]
                ),
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}", "ElectroRobot now ready to work!"
            )
        except Unauthorized:
            LOGGER.warning(
